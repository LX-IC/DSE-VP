...
struct SimpleBus : public sc_core::sc_module, public PwtModule {//libtlmpwt
	...
	SimpleBus(sc_core::sc_module_name) : PwtModule(this) {//libtlmpwt
		#ifdef LIBTLMPWT
		set_activity(SimpleBus_set_activity);//libtlmpwt
		#endif
		for (auto &s : tsocks) {
	...
	void transport(tlm::tlm_generic_payload &trans, sc_core::sc_time &delay) {
		...
		add_activity(SimpleBus_add_activity, (delay.value() / clock_cycle.value()));//libtlmpwt
		#endif
	}
...
struct PeripheralWriteConnector : sc_core::sc_module, public PwtModule {//libtlmpwt
	...
	PeripheralWriteConnector(sc_core::sc_module_name) : PwtModule(this) {//libtlmpwt
		#ifdef LIBTLMPWT
		set_activity(SimpleBus_set_activity);//libtlmpwt
		#endif
