#ifndef TLM_SM4_TOP_H
#define TLM_SM4_TOP_H
...
class TLM_SM4_top:public sc_module{
    public:
        SC_HAS_PROCESS(TLM_SM4_top);
        ...
        void SM4_REG_AHB_init();

        SM4_REG_AHB SM4_REG_AHB_top;

        AHB_Socket AHB_Socket_bport1;

        TLM_SM4_top(sc_core::sc_module_name name);
};
