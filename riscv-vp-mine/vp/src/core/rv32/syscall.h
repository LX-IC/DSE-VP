...
struct SyscallHandler : public sc_core::sc_module, syscall_emulator_if, public PwtModule {//libtlmpwt
	...
	SyscallHandler(sc_core::sc_module_name) : PwtModule(this) {//libtlmpwt
		#ifdef LIBTLMPWT
		set_activity(SyscallHandler_set_activity);//libtlmpwt
		#endif
	...
	void transport(tlm::tlm_generic_payload &trans, sc_core::sc_time &delay) {
		...
		add_activity(SyscallHandler_add_activity, (delay.value() / clock_cycle.value()));//libtlmpwt
		#endif
		(void)delay;
