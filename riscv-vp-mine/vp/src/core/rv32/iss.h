...
#ifdef LIBTLMPWT
#define NICE_CORE //enable nice core
#endif

#define PIPELINE_TIMING //enable pipeline timing
// #define BRANCH_TIMING   //enable branch timing
// #define CACHE_TIMING    //enable cache timing, must open #define DMI first(tiny32/define.h)
...
struct ISS : public sc_core::sc_module, public external_interrupt_target, public clint_interrupt_target, public iss_syscall_if, public debug_target_if, public PwtModule {//libtlmpwt
	...
	ISS(sc_core::sc_module_name, uint32_t hart_id, bool use_E_base_isa = false);//libtlmpwt
